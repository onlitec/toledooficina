...
print("1. Schema da tabela veículos:")
...
print("2. Índices únicos na tabela veículos:")
...
print("4. Verificando duplicatas de chassi:")
cursor.execute("""
...
print("5. Verificando duplicatas de placa:")
cursor.execute("""
...
print("6. Verificando valores NULL ou vazios no chassi:")
